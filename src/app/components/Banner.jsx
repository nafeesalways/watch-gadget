        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6 md:space-y-8 z-10">
            ...
            <div className="space-y-2">
              <p className="text-gray-600 text-lg line-through">মূল্যঃ ১৯৯৯৯</p>
          ...
          {/* Right Content - Watch Images with Vertical Animation */}
          <div className="relative h-100 md:h-125 lg:h-150 z-10">
            {/* Decorative circle background */}
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-100 h-100 md:w-125 md:h-125 border-4 border-white rounded-full opacity-50" />

            {/* Watch images container with vertical animation */}
            <div className="animate-slide-vertical-up relative h-full flex items-center justify-center">
              <Image
